...
class EmitEventRequest(_message.Message):
    ...
    relations: Relations
    resource_id: str
    def __init__(self, event_resource: _Optional[_Union[_models_pb2.ResourceType, str]] = ..., resource_id: _Optional[str] = ..., event_type: _Optional[_Union[_notification_service_pb2.EventType, str]] = ..., relations: _Optional[_Union[Relations, _Mapping]] = ...) -> None: ...
...
class Relations(_message.Message):
    __slots__ = ["collection", "object_group", "project", "shared_object", "shared_object_group"]
    COLLECTION_FIELD_NUMBER: _ClassVar[int]
    OBJECT_GROUP_FIELD_NUMBER: _ClassVar[int]
    PROJECT_FIELD_NUMBER: _ClassVar[int]
    SHARED_OBJECT_FIELD_NUMBER: _ClassVar[int]
    SHARED_OBJECT_GROUP_FIELD_NUMBER: _ClassVar[int]
    collection: str
    object_group: str
    project: str
    shared_object: str
    shared_object_group: str
    def __init__(self, shared_object: _Optional[str] = ..., object_group: _Optional[str] = ..., shared_object_group: _Optional[str] = ..., collection: _Optional[str] = ..., project: _Optional[str] = ...) -> None: ...
