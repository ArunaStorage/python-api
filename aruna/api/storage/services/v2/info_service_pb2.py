...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_STORAGESTATUSSERVICE'].methods_by_name['GetAnnouncements']._options = None
  ...
  _globals['_STORAGESTATUSSERVICE'].methods_by_name['SetAnnouncements']._options = None
