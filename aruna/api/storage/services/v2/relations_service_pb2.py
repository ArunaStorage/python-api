...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    2,
    '',
    'aruna/api/storage/services/v2/relations_service.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RELATIONSSERVICE'].methods_by_name['ModifyRelations']._loaded_options = None
  ...
  _globals['_RELATIONSSERVICE'].methods_by_name['GetHierarchy']._loaded_options = None
