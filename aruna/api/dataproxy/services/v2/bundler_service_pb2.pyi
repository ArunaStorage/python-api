...
class CreateBundleRequest(_message.Message):
    __slots__ = ("resource_ids", "filename", "expires_at", "once")
    ...
    once: bool
    def __init__(self, resource_ids: _Optional[_Iterable[str]] = ..., filename: _Optional[str] = ..., expires_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., once: bool = ...) -> None: ...
