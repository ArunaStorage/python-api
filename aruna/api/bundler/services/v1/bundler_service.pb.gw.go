...
func RegisterBundlerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BundlerServiceServer) error {
	...
	mux.Handle("POST", pattern_BundlerService_CreateBundle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/aruna.api.bundler.services.v1.BundlerService/CreateBundle", runtime.WithHTTPPathPattern("/v1/collection/{collection_id}/bundle"))
		if err != nil {
	...
	mux.Handle("DELETE", pattern_BundlerService_DeleteBundle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/aruna.api.bundler.services.v1.BundlerService/DeleteBundle", runtime.WithHTTPPathPattern("/v1/collection/{collection_id}/bundle/{bundle_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterBundlerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BundlerServiceClient) error {
	...
	mux.Handle("POST", pattern_BundlerService_CreateBundle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/aruna.api.bundler.services.v1.BundlerService/CreateBundle", runtime.WithHTTPPathPattern("/v1/collection/{collection_id}/bundle"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_BundlerService_DeleteBundle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/aruna.api.bundler.services.v1.BundlerService/DeleteBundle", runtime.WithHTTPPathPattern("/v1/collection/{collection_id}/bundle/{bundle_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_BundlerService_CreateBundle_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "collection", "collection_id", "bundle"}, ""))

	pattern_BundlerService_DeleteBundle_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"v1", "collection", "collection_id", "bundle", "bundle_id"}, ""))
)
