...
_DATASETSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetObjectGroupsStreamLink',
    full_name='api.services.v1.DatasetService.GetObjectGroupsStreamLink',
    index=4,
    containing_service=None,
